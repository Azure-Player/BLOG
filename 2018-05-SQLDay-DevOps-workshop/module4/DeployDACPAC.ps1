...
Function Add-DACAssemblies {
	...
	#$SearchPathList = @("${env:ProgramFiles(x86)}\Microsoft Visual Studio 14.0\Common7\IDE\Extensions\Microsoft\SQLDB\DAC\140")

	Write-Verbose "Searching for: Microsoft.SqlServer.TransactSql.ScriptDom.dll"
	$ScriptDomDLL = (Find-DacFile -FileName "Microsoft.SqlServer.TransactSql.ScriptDom.dll" -PathList $SearchPathList)

	Write-Verbose "Searching for: Microsoft.SqlServer.Dac.dll"
...
Function Invoke-DacPacUtility {
	...
	Try {
        Write-Verbose "Loading dacpacfile...";
        ...
        Write-Verbose "Registering new events of dacServices...";
...
#$SourcePath = "x:\2018-05 SQLDay2018\module4\db"
